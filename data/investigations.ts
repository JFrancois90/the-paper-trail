...
export const investigations: Investigation[] = [
  ...
  },
  {
    ...
    said: 'Used to argue for tuition fee reduction, citing personal financial burden from student debt',
    source: 'Total borrowed: ~£79,000. Tuition, maintenance, and hardship. Will repay: ~£50,000. Difference: £29,000 less than borrowed. Sarah pays back less, not more. The rest is written off after 30 years.',
    sourceImage: null,
    sourceOneLiner: 'Borrowed ~£79,000. Will repay ~£50,000. That\'s £29,000 less, not more.',
    sourceLabel: 'What the maths actually shows',
    impact: 'Borrowed: ~\u00a379,000. Will repay: ~\u00a350,000. That is \u00a329,000 less than Sarah borrowed. Policy claims graduates overpay. This shows the opposite. Wrong numbers risk targeting the wrong people. We take no position on the policy. We are pointing out the input is wrong.',
    ...
    barData: [
      ...
      { label: 'Will actually repay', sublabel: 'Sarah\'s own estimate by age 50', value: 50, color: '#1a6b42', fmt: '~£50,000' },
  ...
  {
    id: 12,
    slug: 'jones-500bn-tax-gap',
    who: 'Baroness Jenny Jones, Green Party',
    party: 'Green',
    date: 'Apr 2026',
    ...
    barData: [
      ...
      { label: 'Mid-sized businesses', sublabel: 'Cumulative share', value: 13.7, color: '#2358a3', fmt: '13.7%' },
      { label: 'Criminals', sublabel: 'Cumulative share', value: 13.0, color: '#1b2a4a', fmt: '13.0%' },
      { label: 'Individuals', sublabel: 'Cumulative share', value: 6.3, color: '#1b2a4a', fmt: '6.3%' },
      { label: 'Wealthy', sublabel: 'Claimed as \u201cmostly\u201D', value: 5.0, color: '#1a6b42', fmt: '5.0%' },
    ],
    whisperChain: null,
    whisperNote: null,
    correction: null,
    questions: [
      'HMRC\u2019s cumulative breakdown attributes 5% of the \u00a3500bn gap to the wealthy and 46% to small businesses. On what basis was the attribution \u201cmostly from the richest\u201D made?',
      'Will you issue a clarification to correct the attribution, while preserving the (correct) \u00a3500bn headline figure?',
      'What checks are applied before statements of this kind are repeated on the Green Party\u2019s own social channels?',
    ],
    multiplier: '~9\u00d7',
    multiplierLabel: 'attribution vs source',
    subject: 'Taxation',
    sourceUrl: 'https://www.instagram.com/p/DXM6z9Sj2Dl/',
    rebuttalStatus: {
      invited: 'Baroness Jenny Jones and Green Party leadership',
