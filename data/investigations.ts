...
export const investigations: Investigation[] = [
  ...
  },
  {
    ...
    sourceImage: null,
    sourceOneLiner: '',
    impact: 'This figure is being used to justify abolishing Indefinite Leave to Remain. If the number behind the policy has been formally withdrawn by its own authors, the evidence base for the policy is gone. The OBR, the UK\'s independent fiscal watchdog, produced analysis pointing in the opposite direction. Voters are being asked to support a policy based on a number that its own source says should no longer be used.',
    analogy: 'Imagine quoting a price from a surveyor\'s report, but the surveyor has since called you to say the report was wrong and not to use it. Then a second surveyor comes back with a completely different number. You ignore both calls and keep quoting the original. That\'s what\'s happening here.',
    barData: [],
    whisperChain: null,
    whisperNote: null,
    sourceLabel: 'What the numbers actually show',
