...
export const investigations: Investigation[] = [
  ...
  },
  {
    ...
    party: 'Reform',
    date: 'Jul 2025',
    claim: '10% of criminals commit 50% of all the crime',
    ...
    source: 'Their own source covers 2000 to 2016 only. The actual figure: 9% of offenders received 52% of convictions. That\'s convictions, not "all the crime." Different things. By 2016, the figure was already falling. Down to 43%. The report is classed as "experimental statistics" by the MoJ. Not established national data. The MoJ publishes quarterly reoffending stats. The latest covers up to 2024. Reform used none of it. __The data ended before Brexit, before COVID, before the cost of living crisis. It\'s being used to describe Britain today.__',
    sourceImage: null,
    sourceOneLiner: '',
    impact: 'Policy should be built on current evidence. The data is 10 to 26 years old. Within the source itself, the trend was declining. More recent MoJ data exists and wasn\'t used. If the current numbers tell a different story, the policy response could be wrong. We\'re not questioning the policy. We\'re questioning the evidence behind it.',
    analogy: 'Imagine telling your insurance company your house was burgled in 2005, and using that to claim your street is dangerous in 2025. They\'d ask for something a bit more recent. That\'s what\'s happening here. A stat from as far back as 2000 is being used to describe Britain right now.',
    barData: [
      { label: 'What they said', sublabel: '"50% of all crime"', value: 50, color: '#b5302a', fmt: '50%' },
      { label: 'Source (overall)', sublabel: '52% of convictions, 2000-2016', value: 52, color: '#1b2a4a', fmt: '52%' },
      { label: 'Source (2016)', sublabel: 'Falling. Down to 43%', value: 43, color: '#1a6b42', fmt: '43%' },
    ],
    whisperChain: null,
    whisperNote: null,
    sourceLabel: 'What the numbers actually show',
  ...
  },
  {
    ...
    source: 'The link goes to an opinion article from June 2017. Written by Simon Marcus on The Conservative Woman. The Conservative Woman is rated Right Biased with Mixed factual reporting by Media Bias/Fact Check. The data in the article covers 2005 to 2016. This is not government data. Not police data. Not an academic study. It\'s the first bullet point of a national policy document. __The source for the first policy action in "Get Offenders off the Street" is a blog post.__',
    sourceImage: null,
    sourceOneLiner: '',
    impact: 'Stop and search is one of the most sensitive policing powers in the UK. A policy on it should cite the strongest possible evidence. Official Home Office stop and search data is published every year. It\'s free. Using an opinion article as the source raises questions about the quality of the evidence base. We\'re not questioning the policy. We\'re questioning why official data wasn\'t used.',
    analogy: 'Imagine applying for a mortgage and handing the bank a blog post instead of your payslips. That\'s roughly what\'s happening here. The first action point in a national policy cites an opinion piece from 2017 instead of official Home Office or police data.',
    barData: [
      { label: 'Expected source', sublabel: 'Home Office statistics', value: 100, color: '#1a6b42', fmt: 'Official' },
      { label: 'Actual source', sublabel: 'Opinion article, 2017', value: 20, color: '#b5302a', fmt: 'Blog post' },
    ],
    whisperChain: null,
    whisperNote: null,
    sourceLabel: 'What their own source shows',
