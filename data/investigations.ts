...
export const investigations: Investigation[] = [
  ...
  },
  {
    ...
    source: 'Ms Whittome studied at the University of Nottingham from 2017 to 2019. She was required to resit her first year (only 4.3% of Nottingham students are in this position). She then left at the end of her second year. With only two years of study, living at home, and no third-year borrowing, the maximum possible student loan balance by October 2019 was approximately \u00a336,000. A balance of \u00a349,600 cannot be reached under those conditions without additional borrowing beyond the standard two academic years.',
    sourceImage: null,
    ...
    impact: 'This figure is being used to argue for tuition fee reduction. If the stated debt is \u00a313,600 higher than what is mathematically possible for the period of study, the personal story underpinning the policy argument doesn\u2019t add up.',
  ...
  },
  {
    ...
    source: 'Reform proposed raising the personal allowance (the amount you earn before paying any tax) from \u00a312,570 to \u00a320,000. That extra \u00a37,430 was taxed at 20%. So the saving is 20% of \u00a37,430 = \u00a31,486. This is the same for everyone earning above \u00a320,000. A \u00a330K earner saves \u00a31,486. A \u00a360K earner saves \u00a31,486. The 40% higher rate band is completely untouched by this change.',
    sourceImage: null,
    sourceOneLiner: '\u00a330K earner saves \u00a31,486. \u00a360K earner saves \u00a31,486. The same amount.',
    sourceLabel: 'What the maths actually shows',
    impact: 'Getting tax band maths wrong misleads people about who benefits from a policy. Whether you support Reform or oppose them, the public deserves accurate analysis.',
