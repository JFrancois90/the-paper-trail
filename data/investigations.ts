...
export const investigations: Investigation[] = [
  ...
  },
  {
    ...
    sourceLabel: 'What the maths actually shows',
    impact: 'The current debate argues poorer households pay back more than they borrow. This case shows the opposite: she borrowed ~£79,000 and will repay ~£50,000. She pays back less, not more. If policy is built on the claim that graduates repay more than they borrow, it risks being designed to fix a problem that doesn\'t exist in the way described, potentially benefiting wealthier students at the expense of the ones it\'s trying to help. We take no position on the policy. We\'re pointing out the input is wrong.',
